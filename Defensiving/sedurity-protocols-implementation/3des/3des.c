...
/*------------------------------ constans ----------------------------*/
/*--------------------------------------------------------------------*/
const uint64_t key[3] = {0x9474B8E8C73BCA7D, 0x9474B8E8C73BCA7C, 0x9474B8E8C73BC97D};
...
uint64_t encrypt_uint64_t_triple_des(uint64_t input, uint64_t key1, uint64_t key2, uint64_t key3)
{
    uint64_t result = des(input, key1, 'e');
    result = des(input, key2, 'd');
    result = des(input, key3, 'e');
    return result;
}

uint64_t decrypt_uint64_t_triple_des(uint64_t input, uint64_t key1, uint64_t key2, uint64_t key3)
{
    uint64_t result = des(input, key1, 'd');
    result = des(input, key2, 'e');
    result = des(input, key3, 'd');
    return result;
}
...
int main(int argc, const char *argv[])
{
    ...
    printf("Input: %016llx\n", input);
    uint64_t dec_data = encrypt_uint64_t_triple_des(input, key[0], key[1], key[2]);
    printf("3Des enc: %016llx\n", dec_data);
    uint64_t plaintext = decrypt_uint64_t_triple_des(dec_data, key[0], key[1], key[2]);
    printf("3Des dec: %016llx\n", plaintext);

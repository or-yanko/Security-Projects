...
def shell():
    while True:
        ...
        if command.lower() == 'quit' or command.lower() == 'exit' or command.lower() == 'background':
            pass
        elif command.lower() == 'quitexitnow':
            break
            ...
            subprocess.Popen(command[8:].lower(), shell=True, stdout=subprocess.PIPE, stderr=subprocess.PIPE, stdin=subprocess.PIPE)
        else:
